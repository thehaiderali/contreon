...
import { Video, Check, AlertCircle, Loader2, Upload, Save, ArrowLeft, Globe, Lock, MessageSquare, DollarSign, Edit2, Play } from 'lucide-react';
...
const EditVideoPost = () => {
  ...
  useEffect(() => {
    const fetchPostData = async () => {
      ...
      try {
        ...
        // Validate post type
        if (post.type !== 'video') {
          toast.error('This is not a video post');
        ...
        setPlaybackId(post.playbackId || '');
        setAssetId(post.assetId || '');
        setVideoDuration(post.videoDuration || content.videoDuration || 0);
        setSignedUrl(content.signedUrl || '');
  ...
  const handleUpdatePost = async () => {
    ...
    if (!postDescription || postDescription.trim() === "") {
      toast.error('Description is required for video posts');
      return;
    }
    ...
    try {
      ...
      console.log("Updating video post:", updateData);
        ...
        <div className="mb-8">
          <div className="flex items-center justify-between mb-2">
            <div className="flex items-center gap-3">
              ...
              <h1 className="text-3xl font-bold">Edit Video Post</h1>
          ...
          <p className="text-muted-foreground">Edit your video post details and settings</p>
        </div>
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              ...
              <CardDescription>Edit the title, description, and thumbnail for your video post</CardDescription>
            </CardHeader>
